(() => {
  const elementIds = Object.freeze({
    ...
    taskRelatedKbFieldEl: "task-related-kb-field",
    taskRelatedKbSelectEl: "task-related-kb-select",
    taskRelatedKbStateEl: "task-related-kb-state",
    ...
    selectedTaskRelatedKbFieldEl: "selected-task-related-kb-field",
    selectedTaskRelatedKbSelectEl: "selected-task-related-kb-select",
    selectedTaskRelatedKbStateEl: "selected-task-related-kb-state",
