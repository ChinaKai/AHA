(() => {
  const elementIds = Object.freeze({
    ...
    taskContextAutoCompactEnabledEl: "task-context-auto-compact-enabled",
    taskContextThresholdFieldEl: "task-context-threshold-field",
    taskContextThresholdEl: "task-context-threshold",
