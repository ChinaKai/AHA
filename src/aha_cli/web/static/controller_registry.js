(() => {
  const elementIds = Object.freeze({
    ...
    ahaPromptsEl: "aha-prompts",
    promptsDialogEl: "prompts-dialog",
    closePromptsEl: "close-prompts",
    promptsContentEl: "prompts-content",
    ahaPermissionsEl: "aha-permissions",
    permissionsDialogEl: "permissions-dialog",
    closePermissionsEl: "close-permissions",
    permissionsContentEl: "permissions-content",
    ...
    taskBrowserEditorEl: "task-browser-editor",
    taskBrowserFormEl: "task-browser-form",
    taskBrowserStateEl: "task-browser-state",
    ...
    commandPaletteInputEl: "command-palette-input",
    commandPaletteListEl: "command-palette-list",
    commandPaletteHintsEl: "command-palette-hints",
