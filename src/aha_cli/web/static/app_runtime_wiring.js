...
const initialControllers = window.AHAAppControllerFactory.createInitialControllers(domRefs, {
  ...
  mountVirtualConversation: (...args) => conversationController?.mountVirtualConversation?.(...args),
  isVirtualConversation: (...args) => conversationController?.isVirtualConversation?.(...args),
  updateMountedVirtualConversation: (...args) => conversationController?.updateMountedVirtualConversation?.(...args),
