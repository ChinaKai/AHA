(function () {
  ...
  function createVirtualList(container, options = {}) {
    ...
    function render() {
      ...
      // Clear children except spacer.
      while (scrollEl.firstChild && scrollEl.firstChild !== spacerEl) scrollEl.removeChild(scrollEl.firstChild);
    ...
    function unmount() {
      if (scrollEl && spacerEl) {
        scrollEl.removeEventListener("scroll", requestRender);
