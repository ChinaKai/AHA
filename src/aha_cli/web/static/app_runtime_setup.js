...
const rawRequestTimeoutMs = Number(queryParams.get("timeout") || "30000");
...
const requestTimeoutMs = Number.isFinite(rawRequestTimeoutMs) ? Math.max(1000, rawRequestTimeoutMs) : 30000;
...
let feishuConsoleController = null;
let observeProxyController = null;
let localTerminalController = null;
...
appBridge = window.AHAAppBridge.createAppBridge({
  ...
  feishuConsoleController: () => feishuConsoleController,
  localTerminalController: () => localTerminalController,
