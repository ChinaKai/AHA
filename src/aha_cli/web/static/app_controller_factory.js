(() => {
  ...
  function createInitialControllers(elements = {}, deps = {}) {
    const {
      ...
      selectedTaskContextThresholdFieldEl, selectedTaskRelatedKbFieldEl, selectedTaskRelatedKbSelectEl,
      selectedTaskRelatedKbStateEl, selectedTaskMetaEl, selectedTaskProxyEnabledEl,
      ...
      taskContextEditorEl, taskContextFormEl, taskContextStateEl, taskModelEl, taskReasoningEffortEl,
    ...
    const taskConfigController = window.AHATaskConfigController.createTaskConfigController({
      ...
      els: {
        ...
        selectedTaskRelatedKbFieldEl,
        selectedTaskRelatedKbSelectEl,
        selectedTaskRelatedKbStateEl,
        taskContextStateEl,
        taskObserveProxyEditorEl,
        taskObserveProxyFormEl,
        selectedTaskObserveProxyEnabledEl,
        taskObserveProxyStateEl,
        taskSkillsEditorEl,
        taskSkillsFormEl,
      ...
      helpers: {
        ...
        taskObserveProxyPolicy: deps.taskObserveProxyPolicy,
        taskObserveProxySummary: deps.taskObserveProxySummary,
    ...
    const panelController = window.AHAPanelController.createPanelController({
      ...
      contextEvidenceDetail: deps.contextEvidenceDetail,
  ...
  function createFeatureControllers(elements = {}, deps = {}) {
    ...
    const agentConfigController = window.AHAAgentConfigController.createAgentConfigController({
      ...
      reasoningEffortSelectOptions: (backend, model, current) => deps.runtimeOptions?.reasoningEffortSelectOptions(backend, model, current),
      ...
      fillReasoningEffortSelect: (select, backend, model, selected = "") => deps.runtimeOptions?.fillReasoningEffortSelect(select, backend, model, selected),
    ...
    const observeProxyController = window.AHAObserveProxy.createObserveProxyController({
      observeProxyEl,
    ...
    const taskCreateController = window.AHATaskCreateController.createTaskCreateController({
      ...
      taskRelatedKbFieldEl,
      taskRelatedKbSelectEl,
      taskRelatedKbStateEl,
      taskObserveProxyEnabledEl,
      taskSkillSelectEl,
      taskDraftStateEl,
      taskFormEl,
