(() => {
  ...
  function createFeatureControllers(elements = {}, deps = {}) {
    const {
      ...
      taskMemoCalendarEl, taskMemoCancelEl, taskMemoConvertEl, taskMemoDeleteEl, taskMemoDialogEl,
      taskMemoCurrentMonthEl,
      taskMemoEditDateEl, taskMemoEditDescriptionEl, taskMemoEditStatusEl, taskMemoEditorHintEl, taskMemoEditorTitleEl,
      taskMemoEditTitleEl, taskMemoFilterEl, taskMemoFormEl, taskMemoListEl,
      ...
      taskMemoTaskLinkClearEl, taskMemoTaskLinkFieldEl, taskMemoTaskLinkSummaryEl,
