(() => {
  ...
  function createFeatureControllers(elements = {}, deps = {}) {
    const {
      ...
      deleteTaskDraftEl, mobileActionsToggleEl, newTaskDescriptionEl, newTaskTitleEl, playConsoleEl,
      playConsolePopoverEl, restoreTaskDraftEl, saveTaskDraftEl, selectedAgentInfoEl, sendFormEl, sessionMenuEl, settingsContentEl,
      settingsDialogEl, taskApprovalEl, taskBackendEl, taskCreateConfirmDetailsEl,
      taskCreateConfirmDialogEl, taskCreateDialogEl, taskDraftSelectEl, taskDraftStateEl, taskFormEl, taskModelEl,
