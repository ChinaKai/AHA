...
def build_parser(handlers: Mapping[str, Callable[[argparse.Namespace], int]]) -> argparse.ArgumentParser:
    ...
    kb_list.add_argument("--kind", choices=["wiki", "solutions", "navigation"], default=None)
    ...
    kb_add = kb_sub.add_parser("add", help="Create/update a knowledge entry (wiki or solution)")
    kb_add.add_argument("--scope", choices=["general", "project", "personal"], default="general")
    kb_add.add_argument("--kind", choices=["wiki", "solutions"], default="wiki")
    ...
    task_complete = task_sub.add_parser("complete", help="Mark a task completed without generating a Final")
