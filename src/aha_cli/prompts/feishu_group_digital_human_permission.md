...
- When a read_paths allowlist is present in the source index, everything under each listed path is readable; never read or reference paths outside the allowlist.
