...
class FrontendStaticTests(unittest.TestCase):
    ...
    def test_frontend_uses_bootstrap_for_empty_state(self) -> None:
        ...
        self.assertIn("confirmBootstrapConfigSave", script)
        self.assertIn("Save AHA Settings to .aha/config.json?", script)
        ...
        self.assertIn("payload.model = taskModelEl.value || null", script)
    ...
    def test_frontend_uses_modal_for_task_create(self) -> None:
        ...
        self.assertIn("确认将 ${agent.id} config", script)
        self.assertIn("renderAgents();", script)
    ...
    def test_frontend_prefills_empty_proxy_inputs_from_defaults(self) -> None:
        ...
        self.assertIn("function applyProxyDefaultValue", script)
        self.assertIn("function fillTaskCreateProxyDefaultFor", script)
        self.assertIn("function fillSelectedTaskProxyDefaultFor", script)
        self.assertNotIn("function applyProxyDefaultValues", script)
        self.assertNotIn("function fillBootstrapProxyDefaults", script)
        self.assertIn('input?.addEventListener("focus", () => fillSelectedTaskProxyDefaultFor(input));', script)
        self.assertIn('input?.addEventListener("click", () => fillTaskCreateProxyDefaultFor(input));', script)
