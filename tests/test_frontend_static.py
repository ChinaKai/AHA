...
class FrontendStaticTests(unittest.TestCase):
    ...
    def test_frontend_renders_prompt_metrics_visualization(self) -> None:
        ...
        self.assertIn("const contextUsedTotalLabel = contextInputTokens != null && contextWindowTokens != null", script)
        self.assertIn("used ${formatMetricNumber(contextInputTokens)} / total ${formatMetricNumber(contextWindowTokens)} tokens", script)
        self.assertIn("total window ${formatMetricNumber(contextWindowTokens)} tokens", script)
