...
class WebTaskApiTests(unittest.TestCase):
    ...
    def test_api_task_create_and_update_accepts_browser_control_config(self) -> None:
        ...
        self.assertEqual(body["task"]["browser_control"]["display"], "native")
        self.assertEqual(body["task"]["browser_control"]["device_mode"], "mobile")
        self.assertEqual(update_body["task"]["browser_control"]["profile"], "task")
        self.assertEqual(update_body["task"]["browser_control"]["profile_name"], "")
        self.assertEqual(update_body["task"]["browser_control"]["agent_access"], "read_write")
        self.assertEqual(update_body["task"]["browser_control"]["runtime"], "playwright")
        ...
        self.assertEqual(basic_update_body["task"]["browser_control"]["agent_access"], "read_write")
        self.assertEqual(basic_update_body["task"]["browser_control"]["runtime"], "playwright")
        self.assertEqual(basic_update_body["task"]["browser_control"]["display"], "native")
        ...
        self.assertEqual(basic_update_body["task"]["browser_control"]["downloads"], "allow")
        self.assertEqual(basic_update_body["task"]["browser_control"]["uploads"], "allow")
        self.assertEqual(
        ...
        self.assertEqual([item["name"] for item in named_profiles], [])
        ...
        self.assertEqual(browser_events[-1]["data"]["display"], "native")
        self.assertEqual(browser_events[-1]["data"]["runtime"], "playwright")
        self.assertEqual(browser_events[-1]["data"]["device_mode"], "desktop")
        self.assertEqual(browser_events[-1]["data"]["profile_name"], "")
