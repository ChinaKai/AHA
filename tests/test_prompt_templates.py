...
SAMPLE_VALUES = {
    ...
    "model_family": "kimi",
    "map_counts": "files=1",
    "map_flavors": "c, kconfig",
    "map_index": "/workspace/.aha/runtime/project_context/project/workspace/index.json",
    "map_profiles": "embedded-linux",
    "map_reference": "Project map reference.",
    "map_status": "fresh",
    ...
    "project_map_context": "Project context map.",
